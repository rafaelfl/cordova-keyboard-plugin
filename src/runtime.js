...
//          vvvvvvvv
cr.plugins_.KeyboardPlugin = function(runtime)
{
...
(function ()
{
	...
	// *** CHANGE THE PLUGIN ID HERE *** - must match the "id" property in edittime.js
	//                            vvvvvvvv
	var pluginProto = cr.plugins_.KeyboardPlugin.prototype;
	...
	Acts.prototype.enableShrinkView = function ()
	{
		//alert("disable scroll");
